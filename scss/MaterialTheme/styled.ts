...
export const AdminAppBar = styled(MuiAppBar, {
  ...
  // @ts-expect-error: theme, open va drawerwidth propertylari MuiAppBar'ning standart tipida yo'q, lekin biz ularni maxsus qo'shyapmiz
...
export const AdminDrawer = styled(MuiDrawer, {
  ...
  // @ts-expect-error: theme, open va drawerwidth propertylari MuiDrawer'ning standart tipida yo'q, lekin biz ularni maxsus qo'shyapmiz
  ({ theme, open, drawerwidth }) => ({
